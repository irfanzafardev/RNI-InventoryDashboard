...
<div class="page-heading heading bg-darkblue d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-white">Category Form</h1>
</div>

<!-- AddData-form -->
<div class="row">
  <div class="col-12">
    <form method="post" action="/staff/categories">
      @csrf
      <div class="row">
        <div class="col-5">
          ...
          <a href="/staff/categories" class="btn btn btn-light float-end">Cancel</a>
        </div>
      </div>
    </form>
  </div>
