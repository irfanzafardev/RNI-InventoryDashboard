...
Route::middleware('role:admin|superadmin')->group(function () {
  ...
  Route::get('/dashboard/valueGraph', [DashboardConsolidationController::class, 'monthly'])->name('dashboardConsolidationvalueGraph');
...
Route::middleware('role:superadmin')->group(function () {
  ...
  Route::get('/administrator/removeuser/{id}', [AdministratorUserController::class, 'removeuser'])->name('removeUser');
